...
export const sendGridSendRouteParamsSchema = z.object({
  channelProviderId: z.string().min(1).describe('ID of the SendGrid channel provider to use for sending the email'),
});
...
export type SendGridSendRouteParams = z.infer<typeof sendGridSendRouteParamsSchema>;
export type SendGridSendBody = z.infer<typeof sendGridSendBodySchema>;
export type SendGridSendResponse = z.infer<typeof sendGridSendResponseSchema>;
