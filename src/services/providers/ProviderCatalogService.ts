  ...
  private getAsrProviders(): AsrProviderInfo[] {
    return [
      ...
      },
      {
        ...
        description: 'Deepgram speech-to-text API with real-time streaming transcription, smart formatting, and voice activity detection',
        models: [
          {
            id: 'flux-general-en',
            displayName: 'Flux',
            description: 'Latest streaming model with unified ASR and model-native turn detection, optimized for real-time voice agents',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            id: 'nova-3',
            displayName: 'Nova 3',
            description: 'Highest-performing general-purpose ASR with extensive multilingual support',
            recommended: true,
            languages: ['ar', 'be', 'bn', 'bs', 'bg', 'ca', 'hr', 'cs', 'da', 'nl', 'en', 'et', 'fi', 'fr', 'de', 'el', 'he', 'hi', 'hu', 'id', 'it', 'ja', 'kn', 'ko', 'lv', 'lt', 'mk', 'ms', 'mr', 'no', 'fa', 'pl', 'pt', 'ro', 'ru', 'sr', 'sk', 'sl', 'es', 'sv', 'tl', 'ta', 'te', 'tr', 'uk', 'ur', 'vi'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
            supportsStreaming: true,
          },
          {
            ...
            description: 'Medical-specialized Nova 3 model optimized for healthcare terminology',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            id: 'nova-2',
            displayName: 'Nova 2',
            description: 'Previous generation speech recognition with broad language support',
            recommended: false,
            languages: ['bg', 'ca', 'zh', 'cs', 'da', 'nl', 'en', 'et', 'fi', 'fr', 'de', 'el', 'hi', 'hu', 'id', 'it', 'ja', 'ko', 'lv', 'lt', 'ms', 'no', 'pl', 'pt', 'ro', 'ru', 'sk', 'es', 'sv', 'th', 'tr', 'uk', 'vi'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
            supportsStreaming: true,
          },
          ...
          },
          {
            ...
            description: 'Optimized for telephony and phone call audio',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Optimized for financial services terminology',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            displayName: 'Nova 2 Conversational AI',
            description: 'Optimized for conversational AI and chatbot interactions',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Optimized for video content transcription',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Optimized for medical and healthcare terminology',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          {
            id: 'nova-2-drivethru',
            displayName: 'Nova 2 Drive-thru',
            description: 'Optimized for drive-thru and quick service restaurant audio',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Optimized for automotive and in-vehicle audio',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            id: 'nova',
            displayName: 'Nova',
            description: 'Legacy Nova model (predecessor to Nova 2)',
            recommended: false,
            languages: ['en', 'es', 'hi'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Legacy Nova model optimized for telephony',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          {
            id: 'nova-medical',
            displayName: 'Nova Medical',
            description: 'Legacy Nova model optimized for medical terminology',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Enhanced model with high accuracy timestamps and keyword boosting',
            recommended: false,
            languages: ['da', 'nl', 'en', 'fr', 'de', 'hi', 'it', 'ja', 'ko', 'no', 'pl', 'pt', 'es', 'sv', 'ta'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
            supportsStreaming: true,
          },
          {
            ...
            description: 'Enhanced model optimized for meeting audio',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Enhanced model optimized for telephony',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Enhanced model optimized for financial services',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            id: 'base',
            displayName: 'Base',
            description: 'Cost-effective base model for high-volume transcription',
            recommended: false,
            languages: ['zh', 'da', 'nl', 'en', 'fr', 'de', 'hi', 'id', 'it', 'ja', 'ko', 'no', 'pl', 'pt', 'ru', 'es', 'sv', 'tr', 'uk'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
            supportsStreaming: true,
          },
          {
            ...
            description: 'Base model optimized for meeting audio',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Base model optimized for telephony',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Base model optimized for financial services',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            displayName: 'Base Conversational AI',
            description: 'Base model optimized for conversational AI',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Base model optimized for voicemail transcription',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
          ...
          },
          {
            ...
            description: 'Base model optimized for video content',
            recommended: false,
            languages: ['en'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: false,
      ...
      {
        apiType: 'speechmatics',
        displayName: 'Speechmatics',
        description: 'Speechmatics real-time speech-to-text with multi-language support, custom vocabulary, and enhanced transcription modes',
        models: [
          {
            id: 'standard',
            displayName: 'Standard Mode',
            description: 'Standard transcription mode optimized for faster processing and low latency',
            recommended: true,
            languages: ['en', 'en-US', 'en-GB', 'en-AU', 'es', 'fr', 'de', 'it', 'pt', 'pt-BR', 'pt-PT', 'nl', 'ja', 'zh', 'ko', 'ar', 'hi', 'ru', 'pl', 'tr', 'sv', 'da', 'no', 'fi'],
            supportedAudioFormats: ['pcm_8000', 'pcm_16000', 'pcm_44100'],
            supportsCustomVocabulary: true,
            supportsStreaming: true,
          },
          {
            ...
            description: 'Enhanced transcription mode with higher accuracy for complex audio and challenging acoustic environments',
            recommended: false,
            languages: ['en', 'en-US', 'en-GB', 'en-AU', 'es', 'fr', 'de', 'it', 'pt', 'pt-BR', 'pt-PT', 'nl', 'ja', 'zh', 'ko', 'ar', 'hi', 'ru', 'pl', 'tr', 'sv', 'da', 'no', 'fi'],
            supportedAudioFormats: ['pcm_8000', 'pcm_16000', 'pcm_44100'],
            supportsCustomVocabulary: true,
      ...
      },
      {
        apiType: 'soniox',
        displayName: 'Soniox',
        description: 'Soniox real-time speech-to-text with multi-language support, speaker diarization, translation, and context-aware transcription',
        models: [
          {
            id: 'stt-rt-v5',
            displayName: 'STT RT v5',
            description: 'Latest real-time speech recognition model with high accuracy and low latency',
            recommended: true,
            languages: ['af', 'sq', 'ar', 'az', 'eu', 'be', 'bn', 'bs', 'bg', 'ca', 'zh', 'hr', 'cs', 'da', 'nl', 'en', 'et', 'fi', 'fr', 'gl', 'de', 'el', 'gu', 'he', 'hi', 'hu', 'id', 'it', 'ja', 'kn', 'kk', 'ko', 'lv', 'lt', 'mk', 'ms', 'ml', 'mr', 'no', 'fa', 'pl', 'pt', 'ro', 'ru', 'sr', 'sk', 'sl', 'es', 'sv', 'tl', 'ta', 'te', 'th', 'tr', 'uk', 'ur', 'vi'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: true,
            supportsStreaming: true,
          },
          {
            id: 'stt-rt-v4',
            displayName: 'STT RT v4',
            description: 'Previous generation real-time model (deprecated, aliases to v5)',
            recommended: false,
            languages: ['af', 'sq', 'ar', 'az', 'eu', 'be', 'bn', 'bs', 'bg', 'ca', 'zh', 'hr', 'cs', 'da', 'nl', 'en', 'et', 'fi', 'fr', 'gl', 'de', 'el', 'gu', 'he', 'hi', 'hu', 'id', 'it', 'ja', 'kn', 'kk', 'ko', 'lv', 'lt', 'mk', 'ms', 'ml', 'mr', 'no', 'fa', 'pl', 'pt', 'ro', 'ru', 'sr', 'sk', 'sl', 'es', 'sv', 'tl', 'ta', 'te', 'th', 'tr', 'uk', 'ur', 'vi'],
            supportedAudioFormats: ['pcm_16000', 'pcm_8000', 'pcm_22050', 'pcm_24000', 'pcm_44100'],
            supportsCustomVocabulary: true,
  ...
  private getTtsProviders(): TtsProviderInfo[] {
    return [
      ...
      },
      {
        apiType: 'soniox',
        displayName: 'Soniox',
        description: 'Soniox real-time text-to-speech with WebSocket streaming, 28 voices, and 60+ languages',
        models: [
          {
            id: 'tts-rt-v1',
            displayName: 'TTS RT v1',
            description: 'Real-time streaming TTS with low latency',
            recommended: true,
            languages: ['en', 'es', 'fr', 'de', 'it', 'pt', 'nl', 'pl', 'ru', 'ja', 'ko', 'zh', 'hi', 'ar', 'tr', 'sv', 'da', 'fi', 'no', 'cs', 'el', 'he', 'hu', 'ro', 'th', 'vi', 'id', 'ms', 'tl', 'uk', 'bg', 'sk', 'hr', 'bn', 'ta', 'te', 'gu', 'kn', 'ml', 'mr', 'pa', 'ka', 'is', 'cy', 'ca', 'yue', 'cmn'],
            supportedAudioFormats: ['pcm_8000', 'pcm_16000', 'pcm_22050', 'pcm_24000', 'pcm_44100', 'mulaw', 'alaw', 'mp3', 'opus', 'flac', 'aac'],
            supportsFullStreaming: true,
            supportsVoiceSettings: false,
          },
        ],
        ...
        languages: [
          ...
          { code: 'ja', displayName: 'Japanese' },
          { code: 'ko', displayName: 'Korean' },
          { code: 'zh', displayName: 'Chinese (Mandarin)' },
          { code: 'hi', displayName: 'Hindi' },
          { code: 'ar', displayName: 'Arabic' },
          { code: 'tr', displayName: 'Turkish' },
          { code: 'sv', displayName: 'Swedish' },
  ...
  private getLlmProviders(): LlmProviderInfo[] {
    return [
      ...
      },
      {
        ...
        description: 'Mistral AI language models with strong coding and reasoning capabilities',
        models: [
      ...
      },
      {
        ...
        description: 'DeepSeek language models with strong coding and reasoning capabilities via OpenAI-compatible API',
        models: [
      ...
      },
      {
        ...
        description: 'Access hundreds of AI models from multiple providers through a single OpenAI-compatible API',
        models: [
      ...
      },
      {
        ...
        description: 'Fast and cost-efficient open-source model inference via Together AI platform',
        models: [
      ...
      {
        apiType: 'fireworks-ai',
        displayName: 'Fireworks AI',
        description: 'Fast open-source model inference with production-grade reliability from Fireworks AI',
        models: [
      ...
      },
      {
        ...
        description: 'Perplexity AI models with built-in real-time web search and reasoning capabilities',
        models: [
      ...
      },
      {
        apiType: 'cohere',
        displayName: 'Cohere',
        description: 'Cohere language models optimized for enterprise RAG, tool use, and agentic applications',
        models: [
      ...
      },
      {
        ...
        description: 'xAI Grok models with frontier-level intelligence and real-time knowledge',
        models: [
