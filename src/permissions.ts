...
export const PERMISSIONS = {
  ...
  // Sample Copy permissions
  SAMPLE_COPY_READ: 'sample_copy:read',
  SAMPLE_COPY_WRITE: 'sample_copy:write',
  SAMPLE_COPY_DELETE: 'sample_copy:delete',

  // Copy Decorator permissions
  COPY_DECORATOR_READ: 'copy_decorator:read',
  COPY_DECORATOR_WRITE: 'copy_decorator:write',
  COPY_DECORATOR_DELETE: 'copy_decorator:delete',
  ...
  // Quick Prompt permissions
  QUICK_PROMPT_READ: 'quick_prompt:read',
  QUICK_PROMPT_WRITE: 'quick_prompt:write',
  QUICK_PROMPT_DELETE: 'quick_prompt:delete',
...
export const ROLES = {
  ...
  content_manager: {
    ...
    permissions: [
      ...
      PERMISSIONS.GUARDRAIL_WRITE,
      PERMISSIONS.SAMPLE_COPY_READ,
      PERMISSIONS.SAMPLE_COPY_WRITE,
      PERMISSIONS.COPY_DECORATOR_READ,
      PERMISSIONS.COPY_DECORATOR_WRITE,
      ...
      PERMISSIONS.QUICK_PROMPT_READ,
      PERMISSIONS.QUICK_PROMPT_WRITE,
      PERMISSIONS.QUICK_PROMPT_DELETE,
